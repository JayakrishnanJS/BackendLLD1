...
//  Way 1
        // pick the strategy
        //LoginStrategy strategy = LoginStrategyFactory.getLoginStrategy(choice);
...
//  Way 2 : Directly get the 'loginStrategy wrapped in loginContext' from factory
//          a. client don't have to create new context
//          b. client doesn't need to know or import concrete LoginStrategy classes
        LoginContext context = LoginStrategyFactory.getLoginContext(choice1);
        context.login();
        System.out.println();
        ...
        context.setStrategy(LoginStrategyFactory.getLoginContext(choice2));
        context.login();
        System.out.println();
    }
}
