...
public class StudentUtility {
    ...
    // purpose: decoupling and reuse of the “make a copy and do something with it” logic so that our
    // client code doesn’t have to duplicate it every time.
...
//    }
    public static <T extends Student> T createCopy(T proto) {
        ...
        return (T) proto.copy(); // T can be Student or subtype of Student. Casting guarantee that this
        // Student is of Type T
    }
}
/*

Utility classes act as helpers or service for other code components and are not designed to represent
core features or behaviors in a program. Mostly static
 ...
 1. Centralizing common behavior
      ...
      c. Type-Agnostic: Because it accepts the base type, it works for any subtype that implements
         Prototype<Student>
