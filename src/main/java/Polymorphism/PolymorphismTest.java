...
public class PolymorphismTest {
    public static void main(String[] args) {
        ...
        System.out.println("Test 4 (add(int, int)): " + calc.sum(5, 10)); // Expected: 15
        System.out.println("Test 5 (add(double, double)): " + calc.sum(5.5, 4.5)); // Expected: 10.0
        System.out.println("Test 6 (add(int, int, int)): " + calc.sum(1, 2, 3)); // Expected: 6
...
//        f.speak(); // ❌ Throws NullPointerException
        ...
        Dog dog1 = new Dog(); //Local variable 'dog1' is redundant because it is assigned to a1 => Animal a1 = new Dog();
        Animal a1 = dog1;
